...
## Challenges in access patterns for AI use cases (Fabian)

## Overviews and Pyramids for analysis and visualisation of large scale raster data (Felix)
...
## EarthDataLab.jl
Should we replace this by YAXArrays?
...
## Copernicus Data Space Ecosystem (CDSE) (needs to be written)
...
## Discrete Global Grid Systems (DGGS) (Daniel 0.5 pages)
