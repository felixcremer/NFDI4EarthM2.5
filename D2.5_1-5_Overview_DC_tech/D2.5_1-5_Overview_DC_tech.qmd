...
LexCube is a library for interactively visualizing three-dimensional data cubes.
The tool provides a client-server application for visualizing large scale data sets as a six sided cube. 
The interactive visualisation works by pre-generating tiles of the data when the data is started, so that users will experience minimal latency while interacting with the data. 
LexCube was partially developed as a [NFDI4Earth Pilot](https://zenodo.org/records/7822389)
