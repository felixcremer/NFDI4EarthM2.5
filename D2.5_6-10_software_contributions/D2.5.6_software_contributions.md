...
Latest improvements include a major re-design of the package including the implementation of the Zarr v3 specifications. 
...
One remaining challenge in dealing with multi-modal TB to PB-scale geospatial data is the variety of Coordinate Reference systems used for these datasets. 
Because of the size of the dataset, it is infeasible to reproject the data to a common CRS.
Therefore we developed a protoype Julia package SphericalSpatialTrees.jl that provides methods for efficient spatial indexing and searching of geospatial data in different coordinate reference systems.
The package is based on a spherical tree data structure that allows tree queries independent of the CRS used.
It provides methods for nearest neighbor search, range queries, and lazy reprojections of huge datasets.
It is designed to work with large datasets that do not fit into memory and can be used in conjunction with other JuliaGeo packages for efficient geospatial data analysis.
The reprojection is fast enough to allow interactive visualisation of large datasets in different CRS.

The package currently supports different CRSs used for global high-resolution datasets, including EPSG:4326, WebMercator, Equi7, UTM, and ISEA. There is an extension for the package to work with PyramidScheme.jl to lazily reproject every layer of the pyramid. The package is available as open source software at https://github.com/meggart/SphericalSpatialTrees.jl and still under active development. 
...
This standardisation is important so that geospatial datasets can be used across programming languages and tools. 
We are currently working on implementing the GeoZarr standard in the JuliaGeo ecosystem.

# JuliaGeo

We participated in constructing a governance structure for the JuliaGeo ecosystem. 
Fabian Gans and Felix Cremer are currently Steering Committee members of [JuliaGeo](https://github.com/JuliaGeo/governance) 
...
And a third edition was held in [September 2025 in Salzburg](https://spatial-data-science.github.io/2025/)
...
Finally, the fourth workshop will be hosted by an M2.5 partner, Max-Planck-Institute for Biogeochemistry again.
...
- Julia EO Workshop in [2023](https://aircentre.github.io/JuliaEO/), [2025](https://aircentre.github.io/JuliaEO25/) and 2026(https://aircentre.github.io/JuliaEO26/)
...
- [Big Data from Space 2025](https://www.bigdatafromspace2025.org/satellite-event-submission)
...
To enable the use of this concept in different programming languages we provided introduction tutorials at [EGU 2025](https://meetingorganizer.copernicus.org/EGU25/session/55010),  [Living Planet Symposium 2025](https://lps25.esa.int/programme/programme-session/?id=F8A45A91-6492-462A-8FAB-C97EF4E61E4A) and [Big Data from Space 2025](https://www.bigdatafromspace2025.org/)
